<?php $__env->startSection('title', 'Home - GMO Properties'); ?>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <a href="<?php echo e(route('about')); ?>" class="group">
            ...
            <a href="<?php echo e(route('project')); ?>" class="group">
                <div class="bg-white p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="group">
                <div class="bg-white p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user-1/Desktop/My Buuild /gmoproperties/resources/views/home.blade.php ENDPATH**/ ?>