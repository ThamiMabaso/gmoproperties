...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" autocomplete="current-password" required class="appearance-none rounded-none relative block w-full px-3 py-2 border <?php echo e($errors->has('password') ? 'border-red-300' : 'border-gray-300'); ?> placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gmo-gold focus:border-gmo-gold focus:z-10 sm:text-sm" placeholder="Password">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user-1/Desktop/My Buuild /gmoproperties/resources/views/auth/login.blade.php ENDPATH**/ ?>