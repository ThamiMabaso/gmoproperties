...
<div class="max-w-2xl mx-auto space-y-6">
    <p class="text-sm text-gray-600">Control which categories may email you. You will still see alerts in the portal when they occur.</p>

    <form method="post" action="{{ route('tenant.notification-preferences.update') }}" class="bg-white rounded-lg shadow p-6 space-y-5">
        @csrf
        @method('PUT')
        ...
        @php
            $fields = [
                ...
                'email_contracts' => 'Contracts',
                'email_invoices' => 'Invoices',
                'email_maintenance' => 'Maintenance',
